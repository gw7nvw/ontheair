...
#converts any array of hash into a csv
#leaves out any sensitive columns like tokens, digests, passwords
...
require 'rexml/document'
   ...
   assets.each do |a|
     if a.location then
       ...
       if a.r_field('points') then
         number=a.r_field('points')
         if number==10 then number=0 end
         case number
           when 1,2
             colour="Blue"
           when 4,6

...
class Parser::Builders::Default
  ...
  class << self
    ...
    def emit_kwargs; end
    def emit_kwargs=(_); end
    def emit_lambda; end
    def emit_lambda=(_); end
    def emit_match_pattern; end
    def emit_match_pattern=(_); end
...
Parser::CurrentRuby = Parser::Ruby23
...
class Parser::Lexer
  ...
  class << self
    ...
    def lex_en_inside_string=(_); end
...
Parser::Lexer::Dedenter::TAB_WIDTH = T.let(T.unsafe(nil), Fixnum)
...
Parser::Lexer::Literal::SPACE = T.let(T.unsafe(nil), Fixnum)

Parser::Lexer::Literal::TAB = T.let(T.unsafe(nil), Fixnum)
...
class Parser::LexerStrings
  ...
  def reset; end
  def source_buffer; end
  def source_buffer=(_); end
  def source_pts; end
  def source_pts=(_); end
...
Parser::MaxNumparamStack::ORDINARY_PARAMS = T.let(T.unsafe(nil), Fixnum)

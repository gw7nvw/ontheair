...
DomainName::Punycode::BASE = T.let(T.unsafe(nil), Fixnum)

class DomainName::Punycode::BufferOverflowError < ::DomainName::Punycode::ArgumentError
end

DomainName::Punycode::CUTOFF = T.let(T.unsafe(nil), Fixnum)

DomainName::Punycode::DAMP = T.let(T.unsafe(nil), Fixnum)
...
DomainName::Punycode::INITIAL_BIAS = T.let(T.unsafe(nil), Fixnum)

DomainName::Punycode::INITIAL_N = T.let(T.unsafe(nil), Fixnum)

DomainName::Punycode::LOBASE = T.let(T.unsafe(nil), Fixnum)

DomainName::Punycode::MAXINT = T.let(T.unsafe(nil), Fixnum)

DomainName::Punycode::PREFIX = T.let(T.unsafe(nil), String)

DomainName::Punycode::RE_NONBASIC = T.let(T.unsafe(nil), Regexp)

DomainName::Punycode::SKEW = T.let(T.unsafe(nil), Fixnum)

DomainName::Punycode::TMAX = T.let(T.unsafe(nil), Fixnum)

DomainName::Punycode::TMIN = T.let(T.unsafe(nil), Fixnum)

...
RSpec::Core::Formatters::DeprecationFormatter::DelayedPrinter::TOO_MANY_USES_LIMIT = T.let(T.unsafe(nil), Fixnum)
...
RSpec::Core::Formatters::Helpers::DEFAULT_PRECISION = T.let(T.unsafe(nil), Fixnum)

RSpec::Core::Formatters::Helpers::SUB_SECOND_PRECISION = T.let(T.unsafe(nil), Fixnum)
...
RSpec::Core::Ordering::Random::MAX_32_BIT = T.let(T.unsafe(nil), Fixnum)

...
HTMLEntities::VERSION::MAJOR = T.let(T.unsafe(nil), Fixnum)

HTMLEntities::VERSION::MINOR = T.let(T.unsafe(nil), Fixnum)

HTMLEntities::VERSION::STRING = T.let(T.unsafe(nil), String)

HTMLEntities::VERSION::TINY = T.let(T.unsafe(nil), Fixnum)

...
class PG::Connection
  ...
  class << self
    def conndefaults; end
    def connect(*_); end
    def connect_start(*_); end
    def encrypt_password(_, _); end
    def escape(_); end
    def escape_bytea(_); end
    def escape_string(_); end
    def isthreadsafe; end
...
PG::Constants::CONNECTION_AUTH_OK = T.let(T.unsafe(nil), Fixnum)

PG::Constants::CONNECTION_AWAITING_RESPONSE = T.let(T.unsafe(nil), Fixnum)

PG::Constants::CONNECTION_BAD = T.let(T.unsafe(nil), Fixnum)

PG::Constants::CONNECTION_MADE = T.let(T.unsafe(nil), Fixnum)

PG::Constants::CONNECTION_NEEDED = T.let(T.unsafe(nil), Fixnum)

PG::Constants::CONNECTION_OK = T.let(T.unsafe(nil), Fixnum)

PG::Constants::CONNECTION_SETENV = T.let(T.unsafe(nil), Fixnum)

PG::Constants::CONNECTION_SSL_STARTUP = T.let(T.unsafe(nil), Fixnum)

PG::Constants::CONNECTION_STARTED = T.let(T.unsafe(nil), Fixnum)

PG::Constants::INVALID_OID = T.let(T.unsafe(nil), Fixnum)

PG::Constants::INV_READ = T.let(T.unsafe(nil), Fixnum)

PG::Constants::INV_WRITE = T.let(T.unsafe(nil), Fixnum)

PG::Constants::InvalidOid = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PGRES_BAD_RESPONSE = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PGRES_COMMAND_OK = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PGRES_COPY_BOTH = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PGRES_COPY_IN = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PGRES_COPY_OUT = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PGRES_EMPTY_QUERY = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PGRES_FATAL_ERROR = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PGRES_NONFATAL_ERROR = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PGRES_POLLING_FAILED = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PGRES_POLLING_OK = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PGRES_POLLING_READING = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PGRES_POLLING_WRITING = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PGRES_SINGLE_TUPLE = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PGRES_TUPLES_OK = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PG_DIAG_COLUMN_NAME = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PG_DIAG_CONSTRAINT_NAME = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PG_DIAG_CONTEXT = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PG_DIAG_DATATYPE_NAME = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PG_DIAG_INTERNAL_POSITION = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PG_DIAG_INTERNAL_QUERY = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PG_DIAG_MESSAGE_DETAIL = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PG_DIAG_MESSAGE_HINT = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PG_DIAG_MESSAGE_PRIMARY = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PG_DIAG_SCHEMA_NAME = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PG_DIAG_SEVERITY = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PG_DIAG_SOURCE_FILE = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PG_DIAG_SOURCE_FUNCTION = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PG_DIAG_SOURCE_LINE = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PG_DIAG_SQLSTATE = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PG_DIAG_STATEMENT_POSITION = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PG_DIAG_TABLE_NAME = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PQERRORS_DEFAULT = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PQERRORS_TERSE = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PQERRORS_VERBOSE = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PQPING_NO_ATTEMPT = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PQPING_NO_RESPONSE = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PQPING_OK = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PQPING_REJECT = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PQTRANS_ACTIVE = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PQTRANS_IDLE = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PQTRANS_INERROR = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PQTRANS_INTRANS = T.let(T.unsafe(nil), Fixnum)

PG::Constants::PQTRANS_UNKNOWN = T.let(T.unsafe(nil), Fixnum)

PG::Constants::SEEK_CUR = T.let(T.unsafe(nil), Fixnum)

PG::Constants::SEEK_END = T.let(T.unsafe(nil), Fixnum)

PG::Constants::SEEK_SET = T.let(T.unsafe(nil), Fixnum)

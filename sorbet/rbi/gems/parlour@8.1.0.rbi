...
Parlour::Debugging::Tree::INDENT_SPACES = T.let(T.unsafe(nil), Fixnum)
...
module Parlour::Mixin::Searchable
  ...
  def children; end
  sig { params(name: T.nilable(String), type: T.nilable(Class)).returns(T.untyped) }
  def find(name: T.unsafe(nil), type: T.unsafe(nil)); end
  sig { params(name: T.nilable(String), type: T.nilable(Class)).returns(T::Array[T.untyped]) }
  def find_all(name: T.unsafe(nil), type: T.unsafe(nil)); end

  private

  sig { params(child: T.untyped, name: T.nilable(String), type: T.nilable(Class)).returns(T::Boolean) }

...
module Rails::Generators::Actions
  ...
  def application(data = T.unsafe(nil), options = T.unsafe(nil), &block); end
  def capify!; end
  def environment(data = T.unsafe(nil), options = T.unsafe(nil), &block); end
  def gem(*args); end
...
class Rails::Generators::TestCase < ::ActiveSupport::TestCase
  ...
  def current_path=(_); end
  def current_path?; end
  def default_arguments; end
  def default_arguments=(_); end
  def default_arguments?; end
  def destination_root; end
  def destination_root=(_); end
  def destination_root?; end
  def generator_class; end
  def generator_class=(_); end
  def generator_class?; end
...
module Rails::Info
  ...
  class << self
    def framework_version(framework); end
    def frameworks; end
    def inspect; end
    def properties; end
    def properties=(obj); end
...
class Rails::Railtie
  ...
  class << self
    ...
    def generate_railtie_name(class_or_module); end
...
Rails::VERSION::MAJOR = T.let(T.unsafe(nil), Fixnum)

Rails::VERSION::MINOR = T.let(T.unsafe(nil), Fixnum)

Rails::VERSION::STRING = T.let(T.unsafe(nil), String)

Rails::VERSION::TINY = T.let(T.unsafe(nil), Fixnum)

...
MultiJson::OptionsCache::MAX_CACHE_SIZE = T.let(T.unsafe(nil), Fixnum)
...
MultiJson::Version::MAJOR = T.let(T.unsafe(nil), Fixnum)

MultiJson::Version::MINOR = T.let(T.unsafe(nil), Fixnum)

MultiJson::Version::PATCH = T.let(T.unsafe(nil), Fixnum)

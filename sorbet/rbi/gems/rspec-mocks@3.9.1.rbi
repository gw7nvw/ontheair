...
class RSpec::Mocks::Configuration
  ...
  def allow_message_expectations_on_nil=(_); end
  ...
  def temporarily_suppress_partial_double_verification=(_); end
  def transfer_nested_constants=(_); end
  def transfer_nested_constants?; end
  def verify_doubled_constant_names=(_); end
  ...
  def yield_receiver_to_any_instance_implementation_blocks=(_); end
...
class RSpec::Mocks::Implementation
  ...
  def initial_action=(_); end
  def inner_action; end
  def inner_action=(_); end
  def present?; end
  def terminal_action; end
  def terminal_action=(_); end
...
module RSpec::Mocks::MessageExpectation::ImplementationDetails
  ...
  def argument_list_matcher=(_); end
  ...
  def error_generator; end
  def error_generator=(_); end
  def expected_from=(_); end
  def expected_received_count=(_); end
  def implementation=(_); end
...
class RSpec::Mocks::ProxyForNil < ::RSpec::Mocks::PartialDoubleProxy
  ...
  def warn_about_expectations=(_); end

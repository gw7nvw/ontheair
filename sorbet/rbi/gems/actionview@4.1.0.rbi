...
class ActionView::DependencyTracker
  class << self
    def find_dependencies(name, template); end
...
class ActionView::Digestor
  ...
  class << self
    def cache; end
    def digest(options); end

    private

    def compute_and_store_digest(cache_key, options); end
  end
end
...
module ActionView::Helpers::DateHelper
  ...
  def distance_of_time_in_words_to_now(from_time, include_seconds_or_options = T.unsafe(nil)); end
...
module ActionView::Helpers::TagHelper
  ...
  def data_tag_option(key, value, escape); end
...
class ActionView::Helpers::Tags::Base
  ...
  def select_not_required?(html_options); end
  def tag_id; end
  def tag_id_with_index(index); end
  def tag_name(multiple = T.unsafe(nil)); end
  def tag_name_with_index(index, multiple = T.unsafe(nil)); end
...
module ActionView::Helpers::TranslationHelper
  ...
  def wrap_translate_defaults(defaults); end
end
...
module ActionView::Helpers::UrlHelper
  ...
  def token_tag(token = T.unsafe(nil)); end
end
...
module ActionView::Layouts
  ...
  def _default_layout(require_layout = T.unsafe(nil)); end
...
class ActionView::LookupContext
  ...
  class << self
    def fallbacks; end
    def fallbacks=(obj); end
    def register_detail(name, options = T.unsafe(nil), &block); end
    def registered_details; end
    def registered_details=(obj); end
  end
end
...
class ActionView::MissingRequestError < ::StandardError
end
...
ActionView::PartialRenderer::PREFIXED_PARTIAL_NAMES = T.let(T.unsafe(nil), ThreadSafe::Cache)
...
class ActionView::PathResolver < ::ActionView::Resolver
  ...
  def find_templates(name, prefix, partial, details); end
  def mtime(p); end
  def query(path, details, formats); end
end
...
ActionView::Template::Error::SOURCE_CODE_RADIUS = T.let(T.unsafe(nil), Fixnum)
...
class ActionView::TemplateRenderer < ::ActionView::AbstractRenderer
  ...
  def find_layout(layout, keys); end
  def render(context, options); end
  def render_template(template, layout_name = T.unsafe(nil), locals = T.unsafe(nil)); end
  def render_with_layout(path, locals); end
  def resolve_layout(layout, keys); end
end
...
ActionView::VERSION::MAJOR = T.let(T.unsafe(nil), Fixnum)

ActionView::VERSION::MINOR = T.let(T.unsafe(nil), Fixnum)

ActionView::VERSION::STRING = T.let(T.unsafe(nil), String)

ActionView::VERSION::TINY = T.let(T.unsafe(nil), Fixnum)
...
class ActionView::PartialDigestor < ::ActionView::Digestor
  def partial?; end
end
...
class HTML::FullSanitizer < ::HTML::Sanitizer
  def process_node(node, result, options); end
  def sanitize(text, options = T.unsafe(nil)); end
end

class HTML::LinkSanitizer < ::HTML::FullSanitizer
...
class HTML::Node
  ...
  class << self
    def parse(parent, line, pos, content, strict = T.unsafe(nil)); end
  end
end
...
class HTML::Selector
  ...
  class << self
    def for_class(cls); end
    def for_id(id); end
  end
end

class HTML::Selector::InvalidSelectorError < ::StandardError
end

class HTML::Tag < ::HTML::Node
  ...
  def match_condition(value, condition); end
end

class HTML::Text < ::HTML::Node
...
class HTML::Tokenizer
  ...
  def consume_quoted_regions; end
  def scan_tag; end
  def scan_text; end
  def update_current_line(text); end
end

module HTML::Version
end

HTML::Version::MAJOR = T.let(T.unsafe(nil), Fixnum)

HTML::Version::MINOR = T.let(T.unsafe(nil), Fixnum)

HTML::Version::STRING = T.let(T.unsafe(nil), String)

HTML::Version::TINY = T.let(T.unsafe(nil), Fixnum)

class HTML::WhiteListSanitizer < ::HTML::Sanitizer
  ...
  class << self
    ...
    def allowed_attributes?; end
    def allowed_css_keywords; end
    def allowed_css_keywords=(val); end
    def allowed_css_keywords?; end
    def allowed_css_properties; end
    def allowed_css_properties=(val); end
    def allowed_css_properties?; end
    def allowed_protocols; end
    def allowed_protocols=(val); end
    def allowed_protocols?; end
    def allowed_tags; end
    def allowed_tags=(val); end
    def allowed_tags?; end
    def bad_tags; end
    def bad_tags=(val); end
    def bad_tags?; end
    def protocol_separator; end
    def protocol_separator=(val); end
    def protocol_separator?; end
    def shorthand_css_properties; end
    def shorthand_css_properties=(val); end
    def shorthand_css_properties?; end
    def uri_attributes; end
    def uri_attributes=(val); end
    def uri_attributes?; end
  end
end

class HTML::Conditions < ::Hash
  def initialize(hash); end


  private

  def keys_to_strings(hash); end

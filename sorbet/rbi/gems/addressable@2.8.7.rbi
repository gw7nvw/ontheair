...
Addressable::IDNA::ACE_MAX_LENGTH = T.let(T.unsafe(nil), Fixnum)

Addressable::IDNA::ACE_PREFIX = T.let(T.unsafe(nil), String)

Addressable::IDNA::COMPOSITION_TABLE = T.let(T.unsafe(nil), Hash)

Addressable::IDNA::PUNYCODE_BASE = T.let(T.unsafe(nil), Fixnum)

Addressable::IDNA::PUNYCODE_DAMP = T.let(T.unsafe(nil), Fixnum)

Addressable::IDNA::PUNYCODE_DELIMITER = T.let(T.unsafe(nil), Fixnum)

Addressable::IDNA::PUNYCODE_INITIAL_BIAS = T.let(T.unsafe(nil), Fixnum)

Addressable::IDNA::PUNYCODE_INITIAL_N = T.let(T.unsafe(nil), Fixnum)

Addressable::IDNA::PUNYCODE_MAXINT = T.let(T.unsafe(nil), Bignum)

Addressable::IDNA::PUNYCODE_PRINT_ASCII = T.let(T.unsafe(nil), String)

Addressable::IDNA::PUNYCODE_SKEW = T.let(T.unsafe(nil), Fixnum)

Addressable::IDNA::PUNYCODE_TMAX = T.let(T.unsafe(nil), Fixnum)

Addressable::IDNA::PUNYCODE_TMIN = T.let(T.unsafe(nil), Fixnum)
...
Addressable::IDNA::UNICODE_DATA_CANONICAL = T.let(T.unsafe(nil), Fixnum)

Addressable::IDNA::UNICODE_DATA_COMBINING_CLASS = T.let(T.unsafe(nil), Fixnum)

Addressable::IDNA::UNICODE_DATA_COMPATIBILITY = T.let(T.unsafe(nil), Fixnum)

Addressable::IDNA::UNICODE_DATA_EXCLUSION = T.let(T.unsafe(nil), Fixnum)

Addressable::IDNA::UNICODE_DATA_LOWERCASE = T.let(T.unsafe(nil), Fixnum)

Addressable::IDNA::UNICODE_DATA_TITLECASE = T.let(T.unsafe(nil), Fixnum)

Addressable::IDNA::UNICODE_DATA_UPPERCASE = T.let(T.unsafe(nil), Fixnum)

Addressable::IDNA::UNICODE_MAX_LENGTH = T.let(T.unsafe(nil), Fixnum)
...
Addressable::VERSION::MAJOR = T.let(T.unsafe(nil), Fixnum)

Addressable::VERSION::MINOR = T.let(T.unsafe(nil), Fixnum)

Addressable::VERSION::STRING = T.let(T.unsafe(nil), String)

Addressable::VERSION::TINY = T.let(T.unsafe(nil), Fixnum)

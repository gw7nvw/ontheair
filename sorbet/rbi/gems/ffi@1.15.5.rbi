...
FFI::DynamicLibrary::RTLD_ALL_MASK = T.let(T.unsafe(nil), Fixnum)

FFI::DynamicLibrary::RTLD_BINDING_MASK = T.let(T.unsafe(nil), Fixnum)

FFI::DynamicLibrary::RTLD_DEEPBIND = T.let(T.unsafe(nil), Fixnum)

FFI::DynamicLibrary::RTLD_FIRST = T.let(T.unsafe(nil), Fixnum)

FFI::DynamicLibrary::RTLD_GLOBAL = T.let(T.unsafe(nil), Fixnum)

FFI::DynamicLibrary::RTLD_LAZY = T.let(T.unsafe(nil), Fixnum)

FFI::DynamicLibrary::RTLD_LOCAL = T.let(T.unsafe(nil), Fixnum)

FFI::DynamicLibrary::RTLD_LOCATION_MASK = T.let(T.unsafe(nil), Fixnum)

FFI::DynamicLibrary::RTLD_MEMBER = T.let(T.unsafe(nil), Fixnum)

FFI::DynamicLibrary::RTLD_NODELETE = T.let(T.unsafe(nil), Fixnum)

FFI::DynamicLibrary::RTLD_NOLOAD = T.let(T.unsafe(nil), Fixnum)

FFI::DynamicLibrary::RTLD_NOW = T.let(T.unsafe(nil), Fixnum)
...
FFI::Platform::ADDRESS_ALIGN = T.let(T.unsafe(nil), Fixnum)

FFI::Platform::ADDRESS_SIZE = T.let(T.unsafe(nil), Fixnum)

FFI::Platform::ARCH = T.let(T.unsafe(nil), String)

FFI::Platform::BIG_ENDIAN = T.let(T.unsafe(nil), Fixnum)

FFI::Platform::BYTE_ORDER = T.let(T.unsafe(nil), Fixnum)

FFI::Platform::CONF_DIR = T.let(T.unsafe(nil), String)

FFI::Platform::CPU = T.let(T.unsafe(nil), String)

FFI::Platform::DOUBLE_ALIGN = T.let(T.unsafe(nil), Fixnum)

FFI::Platform::DOUBLE_SIZE = T.let(T.unsafe(nil), Fixnum)

FFI::Platform::FLOAT_ALIGN = T.let(T.unsafe(nil), Fixnum)

FFI::Platform::FLOAT_SIZE = T.let(T.unsafe(nil), Fixnum)

FFI::Platform::GNU_LIBC = T.let(T.unsafe(nil), String)

FFI::Platform::INT16_ALIGN = T.let(T.unsafe(nil), Fixnum)

FFI::Platform::INT16_SIZE = T.let(T.unsafe(nil), Fixnum)

FFI::Platform::INT32_ALIGN = T.let(T.unsafe(nil), Fixnum)

FFI::Platform::INT32_SIZE = T.let(T.unsafe(nil), Fixnum)

FFI::Platform::INT64_ALIGN = T.let(T.unsafe(nil), Fixnum)

FFI::Platform::INT64_SIZE = T.let(T.unsafe(nil), Fixnum)

FFI::Platform::INT8_ALIGN = T.let(T.unsafe(nil), Fixnum)

FFI::Platform::INT8_SIZE = T.let(T.unsafe(nil), Fixnum)
...
FFI::Platform::LITTLE_ENDIAN = T.let(T.unsafe(nil), Fixnum)

FFI::Platform::LONG_ALIGN = T.let(T.unsafe(nil), Fixnum)

FFI::Platform::LONG_DOUBLE_ALIGN = T.let(T.unsafe(nil), Fixnum)

FFI::Platform::LONG_DOUBLE_SIZE = T.let(T.unsafe(nil), Fixnum)

FFI::Platform::LONG_SIZE = T.let(T.unsafe(nil), Fixnum)

FFI::Platform::NAME = T.let(T.unsafe(nil), String)

FFI::Platform::OS = T.let(T.unsafe(nil), String)

FFI::Platform::OSVERSION = T.let(T.unsafe(nil), Fixnum)
...
FFI::Pointer::SIZE = T.let(T.unsafe(nil), Fixnum)

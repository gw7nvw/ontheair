...
Fugit::Cron::MAX_ITERATION_COUNT = T.let(T.unsafe(nil), Fixnum)
...
Fugit::DAY_S = T.let(T.unsafe(nil), Fixnum)
...
Fugit::Duration::SECOND_ROUND = T.let(T.unsafe(nil), Fixnum)
...
Fugit::Nat::MAX_INPUT_LENGTH = T.let(T.unsafe(nil), Fixnum)
...
Fugit::YEAR_S = T.let(T.unsafe(nil), Fixnum)

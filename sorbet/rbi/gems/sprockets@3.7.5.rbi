...
Sprockets::Cache::FileStore::DEFAULT_MAX_SIZE = T.let(T.unsafe(nil), Fixnum)
...
Sprockets::Cache::MemoryStore::DEFAULT_MAX_SIZE = T.let(T.unsafe(nil), Fixnum)
...
Sprockets::Cache::PEEK_SIZE = T.let(T.unsafe(nil), Fixnum)
...
Sprockets::EncodingUtils::CHARSET_SIZE = T.let(T.unsafe(nil), Fixnum)

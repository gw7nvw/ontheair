...
Sass::Selector::SPECIFICITY_BASE = T.let(T.unsafe(nil), Fixnum)
...
class Sass::Supports::Declaration < ::Sass::Supports::Condition
  ...
  def resolved_name=(_); end
  def resolved_value; end
  def resolved_value=(_); end
  def to_css; end
  def to_src(options); end
  def value; end
  def value=(_); end
...
class Sass::Tree::CssImportNode < ::Sass::Tree::DirectiveNode
  ...
  def resolved_query=(_); end
  def resolved_uri; end
  def resolved_uri=(_); end
  def resolved_value; end
  def supports_condition; end
  def supports_condition=(_); end
  def uri; end
  def uri=(_); end
  def value; end
...
class Sass::Tree::ExtendNode < ::Sass::Tree::Node
  ...
  def resolved_selector=(_); end
  def selector; end
  def selector=(_); end
  def selector_source_range; end
  def selector_source_range=(_); end
...
class Sass::Tree::RuleNode < ::Sass::Tree::Node
  ...
  def parsed_rules=(_); end
  def resolved_rules; end
  def resolved_rules=(_); end
  def rule; end
  def rule=(_); end
  def selector_source_range; end
  def selector_source_range=(_); end
...
Sass::Util::VLQ_BASE = T.let(T.unsafe(nil), Fixnum)

Sass::Util::VLQ_BASE_MASK = T.let(T.unsafe(nil), Fixnum)

Sass::Util::VLQ_BASE_SHIFT = T.let(T.unsafe(nil), Fixnum)

Sass::Util::VLQ_CONTINUATION_BIT = T.let(T.unsafe(nil), Fixnum)

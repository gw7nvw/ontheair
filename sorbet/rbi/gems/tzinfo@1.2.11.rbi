...
TZInfo::JulianDayOfYearTransitionRule::LEAP = T.let(T.unsafe(nil), Fixnum)

TZInfo::JulianDayOfYearTransitionRule::YEAR = T.let(T.unsafe(nil), Fixnum)
...
TZInfo::ZoneinfoTimezoneInfo::GENERATE_UP_TO = T.let(T.unsafe(nil), Fixnum)

TZInfo::ZoneinfoTimezoneInfo::MAX_TIMESTAMP = T.let(T.unsafe(nil), Fixnum)

TZInfo::ZoneinfoTimezoneInfo::MIN_TIMESTAMP = T.let(T.unsafe(nil), Fixnum)

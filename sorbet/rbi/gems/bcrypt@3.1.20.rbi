...
class BCrypt::Engine
  class << self
    ...
    def __bc_crypt(_, _); end
    def __bc_salt(_, _, _); end
  end
end

BCrypt::Engine::DEFAULT_COST = T.let(T.unsafe(nil), Fixnum)

BCrypt::Engine::MAX_COST = T.let(T.unsafe(nil), Fixnum)

BCrypt::Engine::MAX_SALT_LENGTH = T.let(T.unsafe(nil), Fixnum)

BCrypt::Engine::MAX_SECRET_BYTESIZE = T.let(T.unsafe(nil), Fixnum)

BCrypt::Engine::MIN_COST = T.let(T.unsafe(nil), Fixnum)

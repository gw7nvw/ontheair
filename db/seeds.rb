...
AssetType.create({"id"=>25, "name"=>"summit", "table_name"=>"SotaPeak", "has_location"=>true, "has_boundary"=>false, "index_name"=>"summit_code", "display_name"=>"SOTA Summit", "fields"=>nil, "pnp_class"=>"", "keep_score"=>nil, "min_qso"=>4})
...
AssetType.create({"id"=>31, "name"=>"hump", "table_name"=>"Hump", "has_location"=>true, "has_boundary"=>false, "index_name"=>"code", "display_name"=>"HEMA Hump", "fields"=>"", "pnp_class"=>"HEMA", "keep_score"=>true, "min_qso"=>4})

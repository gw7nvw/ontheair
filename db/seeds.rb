...
AssetType.create({"id"=>28, "name"=>"lake", "table_name"=>"Lake", "has_location"=>true, "has_boundary"=>true, "index_name"=>"code", "display_name"=>"Lake", "fields"=>"info_origin", "pnp_class"=>"ZLOTA", "keep_score"=>true, "min_qso"=>2})
...
AssetType.create({"id"=>25, "name"=>"summit", "table_name"=>"SotaPeak", "has_location"=>true, "has_boundary"=>false, "has_elevation"=>true, "index_name"=>"summit_code", "display_name"=>"SOTA Summit", "fields"=>nil, "pnp_class"=>"", "keep_score"=>nil, "min_qso"=>4})
...
AssetType.create({"id"=>31, "name"=>"hump", "table_name"=>"Hump", "has_location"=>true, "has_boundary"=>false, "has_elevation"=>true, "index_name"=>"code", "display_name"=>"HEMA Hump", "fields"=>"", "pnp_class"=>"HEMA", "keep_score"=>true, "min_qso"=>4})

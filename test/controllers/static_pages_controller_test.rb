...
class StaticPagesControllerTest < ActionController::TestCase
  ...
  test "Results" do
    ...
    get :results, params: {sortby: 'hut', scoreby: 'activated'}
    ...
    #Chaser scores
    get :results, params: {sortby: 'hut', scoreby: 'chased'}
    ...
    #Bagged scores
    get :results, params: {sortby: 'hut', scoreby: 'bagged'}
    ...
    #Park scores
    get :results, params: {sortby: 'park', scoreby: 'activated'}
  ...
  test "/spots filtering" do
    ...
    #AM
    get :spots, params: {zone: 'all', mode: 'AM'}
    ...
    #ZLOTA
    get :spots, params: {zone: 'all', class: 'ZLOTA'}

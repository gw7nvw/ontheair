...
class SessionsControllerTest < ActionController::TestCase
  ...
  test "Unsuccessful signin should get login page and error" do
    post :create, params: {session: { email: users(:zl4nvw).callsign, password: 'badpassword' } }
    assert_response :success
  ...
  test "Inactive account refused login" do
    post :create, params: {session: { email: users(:zl4dis).callsign, password: 'dummy' } }
    assert_response :success
  ...
  test "Successful signin should get home page" do
    ...
    post :create, params: {session: { email: users(:zl4nvw).callsign, password: 'dummy' }}

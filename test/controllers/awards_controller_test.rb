...
class AwardsControllerTest < ActionController::TestCase
  ...
  test "Can create an award" do
    ...
    post :create, params: {award: {name: 'new award', description: 'award description', email_text: 'You have earned an award', count_based: true, all_district: false, all_region: false, all_programme: false, p2p: false, user_qrp: false, contact_qrp: false, allow_repeat_visits: true, activated: true, chased: true, programme: 'hut', is_active: true}}
    assert_response :redirect
  ...
  test "Can create a completion award" do
    ...
    post :create, params: {award: {name: 'new award', description: 'award description', email_text: 'You have earned an award', count_based: false, all_district: true, all_region: true, all_programme: true, p2p: true, user_qrp: true, contact_qrp: true, allow_repeat_visits: false, activated: false, chased: false, programme: 'hut', is_active: false}}
    assert_response :redirect
    assert_redirected_to /\/awards\/[0-9]*/
    assert_equal "Success!", flash[:success]
    award=Award.all.order(:created_at).last
  ...
  test "Can update an award" do
    ...
    patch :update, params: {id: award.id, award: {name: 'updated award', description: 'updated description', email_text: 'You have earned an award', count_based: false, all_district: true, all_region: true, all_programme: true, p2p: true, user_qrp: true, contact_qrp: true, allow_repeat_visits: false, activated: false, chased: false, programme: 'hut', is_active: false}}
  ...
  test "Can delete an award" do
    ...
    patch :update, params: {delete: true, id: award.id}
    assert_response :redirect

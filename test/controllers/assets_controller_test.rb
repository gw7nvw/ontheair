...
class AssetsControllerTest < ActionController::TestCase
  ...
  test "Can search by name" do
    ...
    get :index, params: {asset_type: {name: 'all'}, minor: 'on', searchtext: 'park'}
    assert_response :success
    assert_match 'option selected="selected" value="all"', @response.body
  ...
  test "Active toggle" do
    ...
    get :index, params: {asset_type: {name: 'all'}, minor: 'on', active: 0}
    assert_response :success
    ...
    get :index, params: {asset_type: {name: 'all'}, minor: 'on'}
    assert_response :success
  ...
  test "Minor toggle" do
    ...
    get :index, params: {asset_type: {name: 'all'}}
    assert_response :success
  ...
  test "View non existant asset handled correctly" do
    sign_in users(:zl4nvw)
    get :show, params: {id: 'ZLP/XX-9999'}
  ...
  test "View asset shows activators, chasers" do
    ...
    assert_select '#first_activation', /#{user1.callsign} -> #{user3.callsign}/, "first activation expected: #{user1.callsign} -&gt; #{user3.callsign}"
  end
  ...
  test "Edit non existant asset handled correctly" do
    sign_in users(:zl4nvw)
    get :edit, params: {id: 'ZLP/XX-9999'}
    assert_response :redirect
    assert_redirected_to /assets/
  ...
  test "Can delete an asset" do
    ...
    patch :update, params: {delete: true, id: asset.id}
    assert_response :redirect
  ...
  test "Should get associate page" do
    ...
    asset1=create_test_asset(asset_type: 'hut', region: 'CB', description: "This is a comment", location: create_point(173,-45))
    asset2=create_test_asset(asset_type: 'park', region: 'OT', location: create_point(173,-45), test_radius: 0.1)
    get :associations, params: {id: asset1.safecode}
    assert_response :success
  ...
  test "Should get associate page (contained)" do
    ...
    asset1=create_test_asset(asset_type: 'hut', region: 'CB', description: "This is a comment", location: create_point(173,-45))
    asset2=create_test_asset(asset_type: 'park', region: 'OT', location: create_point(173,-45), test_radius: 0.1)
    get :associations, params: {id: asset2.safecode}
    assert_response :success

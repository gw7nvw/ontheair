...
class QueryControllerTest < ActionController::TestCase
  test "Can search by code" do
    ...
    get :index, params: {asset_type: {name: 'all'}, searchtext: asset1.code, assetfield: 'asset', minor: 'on'}
  ...
  test "Can match multiple assets" do
    ...
    get :index, params: {asset_type: {name: 'all'}, searchtext: 'ZLH/CB', assetfield: 'asset', minor: 'on'}
  ...
  test "Can match by name" do
    ...
    get :index, params: {asset_type: {name: 'all'}, searchtext: asset1.name, assetfield: 'asset', minor: 'on'}
  ...
  test "Can include minor assets" do
    ...
    get :index, params: {asset_type: {name: 'all'}, searchtext: 'ZLH/CB', assetfield: 'asset'}
  ...
  test "Can filter by type" do
    ...
    get :index, params: {asset_type: {name: 'park'}, searchtext: '/CB-', assetfield: 'asset', minor: 'on'}

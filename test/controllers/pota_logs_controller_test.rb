...
class PotaLogsControllerTest < ActionController::TestCase
  ...
  test "Should get show log page" do
    ...
    get :show, params: {id: asset1.code, date: log.date.strftime('%Y%m%d'), user: user1.callsign}
    assert_response :success
  ...
  test "Can download a POTA log" do
    ...
    get :download, params: {id: asset1.code, date: log.date.strftime('%Y%m%d'), user: user1.callsign, :format => :adi}
    assert_response :success
  ...
  test "Can send a POTA log" do
    ...
    get :send_email, params: {id: asset1.code, date: log.date.strftime('%Y%m%d'), user: user1.callsign, :format => :adi}
    assert_response :redirect

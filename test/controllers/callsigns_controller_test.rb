...
class CallsignsControllerTest < ActionController::TestCase
  ...
  test "Can update a callsign" do
    ...
    patch :update, params: {id: uc.id, user_callsign: {callsign: 'ZL9CBB', from_date: '2022-01-01', to_date: '2025-01-01'}}
  ...
  test "Invalid callsign params rejected" do
    ...
    patch :update, params: {id: uc.id, user_callsign: {callsign: user2.callsign, from_date: '2022-01-01'}}
  ...
  test "Can create a callsign" do
    ...
    post :create, params: {user_callsign: {user_id: user.id, callsign: 'ZL9CBB', from_date: '2022-01-01', to_date: '2025-01-01'}}

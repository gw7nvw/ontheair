...
class PhotosControllerTest < ActionController::TestCase
  test "Can create new photo" do
    ...
    get :new, params: {topic_id: PHOTO_TOPIC}
    ...
    #create post
    upload_file = fixture_file_upload("image/test.jpeg",'image/jpeg')
    post :create, params: {topic_id: PHOTO_TOPIC, image: {title: 'test image', description: 'This is a description', asset_codes: asset1.code, image: upload_file}}
    assert_response :success
    post=Image.last

...
class DistrictsControllerTest < ActionController::TestCase
  ...
  test "Should get index page" do
    ...
    assert_match /Canterbury/, get_col_test(row,3), "Correct region"
  ...
  test "should show activaity" do
    ...
    #now filter by user1
    get :show, {id: 'CC', callsign: user1.callsign}
    assert_response :success
    ...
    #now filter by user2
    get :show, {id: 'CC', callsign: user2.callsign}
    assert_response :success

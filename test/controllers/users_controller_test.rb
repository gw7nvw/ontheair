...
####################################################################
  test "can view user's bagged assets" do
    ...
    #bagged
    get 'assets', params: {id: 'ZL4NVW', asset_type: 'park', count_type: 'bagged'}
    ...
    #chased
    get 'assets', params: {id: 'ZL4NVW', asset_type: 'park', count_type: 'chased'}
    ...
    get 'assets', params: {id: 'ZL4NVW', asset_type: 'park', count_type: 'activated'}
    #activated
  ...
  test "can view user's bagged summits" do
    ...
    #bagged
    get 'assets', params: {id: 'ZL4NVW', asset_type: 'summit', count_type: 'bagged'}
    #assert_select  "#valid_count", /2/  #cannot check as filled in by js
    ...
    #chased
    get 'assets', params: {id: 'ZL3CC', asset_type: 'summit', count_type: 'chased'}
    #assert_select  "#valid_count", /2/  #cannot check as filled in by js
    assert_select  "#total_count", /3/
    ...
    #activated and qualified
    get 'assets', params: {id: 'ZL4NVW', asset_type: 'summit', count_type: 'activated'}
    #activated
  ...
  test "can view user's progress towards region awards" do
    ...
    get 'region_progress', params: {id: user2.callsign}
    #Breadcrumbs
    assert_select '#crumbs', /Home/
    assert_select '#crumbs', /Users/
  ...
  test "can view user's progress towards district awards" do
    ...
    get 'district_progress', params: {id: user2.callsign, region: 'CB'}
    #Breadcrumbs
    assert_select '#crumbs', /Home/
    assert_select '#crumbs', /Users/
    assert_select '#crumbs', /#{user2.callsign}/
  ...
  test "Can create new user" do
    ...
    post :create, params: {user: {callsign: "ZL1TEST", firstname: "Bob", lastname: "Menzies", email: "bob@bobm.net", home_qth: "Auckland", timezone: 1, password: "dummy", password_confirmation: "dummy", pin: "1234", acctnumber: "+64271234567", logs_pota: true, logs_wwff: true}}
  ...
  test "invalid user params rejected correctly" do
    ...
    post :create, params: {user: {callsign: "ZL1TEST", firstname: "Bob", lastname: "Menzies", email: "bob@bobm.net", home_qth: "Auckland", timezone: 1, password: "dummy", password_confirmation: "dummy2", pin: "1234", acctnumber: "+64271234567", logs_pota: true, logs_wwff: true}}
    assert_response :success
    assert_select "#error_explanation", /Password confirmation/

    #invalid phone format
    post :create, params: {user: {callsign: "ZL1TEST", firstname: "Bob", lastname: "Menzies", email: "bob@bobm.net", home_qth: "Auckland", timezone: 1, password: "dummy", password_confirmation: "dummy", pin: "1234", acctnumber: "0278263132", logs_pota: true, logs_wwff: true}}
    assert_response :success
  ...
  test "can edit user" do
    ...
    sign_in user
    get :edit, params: {id: user.callsign}
    assert_response :success
    ...
    #now post changes
    patch :update, params: {id: user.id, user: {firstname: "Bob2", lastname: "Menzies2", email: "bob2@bobm.net", home_qth: "Auckland2", timezone: 3, pin: "4321", acctnumber: "+64277654321", logs_pota: false, logs_wwff: false}}
    assert_response :success
  ...
  test "can add a topic" do
    ...
    get :show, params: {id: user.callsign}
    assert_response :success
    ...
    get :add, params: {method: 'mail', id: user.callsign, topic_id: ALERT_TOPIC}
    assert_response :success
    ...
    get :delete, params: {method: 'mail', id: user.callsign, topic_id: ALERT_TOPIC}
    assert_response :success

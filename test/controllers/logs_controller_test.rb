...
class LogsControllerTest < ActionController::TestCase
  ...
  test "Index for another user" do
    ...
    get :index, params: {user: user1.callsign}
  ...
  test "Index for an asset" do
    ...
    get :index, params: {user: 'all', asset: asset1.safecode}
    assert_response :success
    #Breadcrumbs
    assert_select '#crumbs', /Home/
    assert_select '#crumbs', /Logs/
  ...
  test "Can create a log" do
    ...
    post :create, params: {log: {callsign1: user1.callsign, asset_codes: asset1.code+','+asset2.code, date: '2022-01-01', is_qrp1: true, is_portable1: true, loc_desc1: 'Good spot', power1: '10'}}
    assert_response :redirect
  ...
  test "Can view edit log form via edit_contact" do
    ...
    get :editcontact, params: {id: contact1.id}
  ...
  test "Can update a log" do
    ...
    post :update, params: {id: log.id, log: {callsign1: user1.callsign, asset_codes: asset3.code+','+asset4.code, date: '2022-01-02', is_qrp1: false, is_portable1: false, loc_desc1: 'Bad spot', power1: '20'}}
    assert_response :redirect
    log.reload
  ...
  test "Can submit a hamrs log" do
    ...
    #upload log
    upload_file = fixture_file_upload("logs/hamrs.adi",'text/plain')
    post :savefile, params: {upload: {doc_callsign: '', doc_location: '', doc_no_create: false, doc_ignore_error: false, doc_do_not_lookup: false, doc: upload_file}}
    assert_response :redirect
  ...
  test "Can submit a eqsl log" do
    ...
    #upload log
    upload_file = fixture_file_upload("logs/eqsl.adi",'text/plain')
    post :savefile, params: {upload: {doc_callsign: user1.callsign, doc_location: asset1.code, doc_no_create: false, doc_ignore_error: false, doc_do_not_lookup: false, doc: upload_file}}
    assert_response :redirect
    log=Log.order(:created_at).last
  ...
  test "Can submit a zldr-logger log" do
    ...
    #upload log
    upload_file = fixture_file_upload("logs/zl2dr.adi",'text/plain')
    post :savefile, params: {upload: {doc_callsign: user1.callsign, doc_location: '', doc_no_create: false, doc_ignore_error: false, doc_do_not_lookup: false, doc: upload_file}}
    assert_response :redirect
    log=Log.order(:created_at).last
  ...
  test "can specify do not lookup on log upload" do
    ...
    upload_file = fixture_file_upload("logs/single.adi",'text/plain')
    post :savefile, params: {upload: {doc_callsign: user1.callsign, doc_location: asset1.code, doc_no_create: false, doc_ignore_error: false, doc_do_not_lookup: true, doc: upload_file}}
    assert_response :redirect
  ...
  test "cannot post log contacts for another user" do
    ...
    data = transform_handsontable_payload([[nil, '00:01', user2.callsign, true, true, 'FM', 145.5, '59', '57', 'John', 'Good spot',nil ,"" , [asset1.code,asset2.code], nil, nil, nil]])
    post :save, params: {id: log.id, data: data, :format => :json}

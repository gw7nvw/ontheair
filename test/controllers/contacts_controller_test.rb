...
class ContactsControllerTest < ActionController::TestCase
  ...
  # INDEX 
  ##################################################################
  test "Cannot view index for a user when not signed in" do
  ...
  test "Index for an asset class" do
    ...
    get :index, params: {user: user1.callsign, class: 'hut'}
    assert_response :success
  ...
  test "Index for orphan contacts" do
    ...
    get :index, params: {user: user1.callsign, orphans: true}
    assert_response :success
  ...
  # SHOW 
  ##################################################################
  test "Cannot view a contact without logging in" do
    user1=create_test_user
    user2=create_test_user
  ...
  test "Can enter new contact from external spot" do
    ...
    spot=create_test_external_spot(user1, code: 'VKFF-0001', frequency: '7.091', mode: 'SSB', activatorCallsign: 'VK2IO')
    cs = ConsolidatedSpot.last
    ...
    assert_select '#contact_frequency' do assert_select "[value=?]", '7.091' end
    assert_select '#contact_mode' do assert_select "[value=?]", 'SSB' end
    assert_select '#contact_is_qrp2'
    assert_select '#contact_is_portable2'
    assert_select '#contact_signal1'
  ...
  test "Can create a chaser contact (and associated log)" do
    ...
    post :create, params: {contact: {callsign1: user1.callsign, callsign2: user2.callsign, asset2_codes: asset1.code+','+asset2.code, date: '2022-01-01', time: '01:02', frequency: '7.090', mode: 'SSB', is_qrp2: true, is_portable2: true, signal1: '59', signal2: '31', comments1: 'Good DX'}}
  ...
  test "User can refute contact with them" do
    ...
    get :refute, params: {id: contact1.id}
    assert_response :redirect
  ...
  test "User can confirm contact with them" do
    ...
    get :confirm, params: {id: contact1.id}
    assert_response :redirect
    assert_redirected_to /contacts/

...
class CommentsControllerTest < ActionController::TestCase
  ...
  test "Should get show page" do
    ...
    assert_select '#asset', asset1.code, "code"
    ...
    assert_select '#description', /#{Regexp.escape(comment.comment)}/, "text"
  end
  ...
  test "Creating user should get show page" do
    ...
    assert_select '#user', /#{user.callsign}/, "Name"
    assert_select '#asset', /#{Regexp.escape(asset1.code)}/, "code"
    assert_select '#date', /#{comment.updated_at.in_time_zone('UTC').strftime('%Y-%m-%d')}/, "Date"
  ...
  test "Admin user should get show page" do
    ...
    assert_select '#user', /#{user.callsign}/, "Name"
    assert_select '#asset', /#{Regexp.escape(asset1.code)}/, "code"
    assert_select '#date', comment.updated_at.in_time_zone('Pacific/Auckland').strftime('%Y-%m-%d'), "Date"
    assert_select '#box_controls', {count: 1, text: /Edit/}
    assert_select '#box_controls', {count: 1, text: /Delete/}
    assert_select '#description', /#{Regexp.escape(comment.comment)}/, "text"
  end
  ...
  test "User should get create page" do
    ...
    get :new, params: {asset: asset1.safecode}
    assert_response :success

    #Breadcrumbs
    assert_select '#crumbs', /Home/
    assert_select '#crumbs', /Comments/
    assert_select '#crumbs', /#{Regexp.escape(asset1.code)}/
    ...
    #form 
    assert_select '#comment_code' do assert_select "[value=?]", asset1.code end
  ...
  test "Can create a comment" do
    ...
    post :create, params: {comment: {code: asset1.code, comment: 'This is a comment'}}
    assert_response :redirect
  ...
  test "invalid comment params rejected correctly" do
    ...
    #no comment
    post :create, params: {comment: {code: asset1.code, comment: ""}}
    assert_response :success
  ...
  test "User should get edit page" do
    ...
    get :edit, params: {id: comment1.id}
    assert_response :success
  ...
  test "Can update a comment" do
    ...
    patch :update, params: {id: comment1.id, comment: {code: asset1.code, comment: 'This is a comment'}}
    assert_response :redirect
    assert_redirected_to "/assets/"+asset1.safecode
  ...
  test "invalid comment update params rejected correctly" do
    ...
    #no comment
    patch :update, params: {id: comment1.id, comment: {code: asset1.code, comment: ''}}
    assert_response :success
    assert_select "#error_explanation", /Comment/
  end
  ...
  test "Can delete a comment" do
    ...
    get :delete, params: {id: comment1.id}
    assert_response :redirect
    assert_redirected_to "/assets/"+asset1.safecode

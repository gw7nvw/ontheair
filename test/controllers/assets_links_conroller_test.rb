...
class AssetLinksControllerTest < ActionController::TestCase
  ...
  test "Create link with valid asset succeeds" do
    ...
    post :create, params: {asset_code: asset1.safecode, asset_link: { contained_code: asset1.safecode, containing_code: asset2.safecode}}
  ...
  test "Create link with invalid contained asset fails" do
    ...
    post :create, params: {asset_code: asset1.safecode, asset_link: { contained_code: 'ZLP_XX-1234', containing_code: asset2.safecode}}
  ...
  test "Create link with invalid containing asset fails" do
    ...
    post :create, params: {asset_code: asset1.safecode, asset_link: { contained_code: asset1.safecode, containing_code: 'ZLP_XX-1234'}}
  ...
  test "Create link with no referring asset succeeds but redirects to /" do
    ...
    post :create, params: {asset_link: { contained_code: asset1.safecode, containing_code: asset2.safecode}}
  ...
  test "Delete link with valid asset succeeds" do
    ...
    post :delete, params: {id: aal.id, asset_code: asset1.safecode}
  ...
  test "Delete link with invalid asset rejected" do
    ...
    post :delete, params: {id: 99999999, asset_code: asset1.safecode}

...
class AssetWebLinksControllerTest < ActionController::TestCase
  ...
  test "Create link with valid asset succeeds" do
    ...
    post :create, params: { asset_web_link: { asset_code: asset1.safecode, link_class: 'other', url: 'http://example.com/test' }}
  ...
  test "Create link with valid asset succeeds - handles https" do
    ...
    post :create, params: { asset_web_link: { asset_code: asset1.safecode, link_class: 'other', url: 'https://example.com/test' }}
  ...
  test "Create link with valid asset succeeds - handles URl without protocol" do
    ...
    post :create, params: { asset_web_link: { asset_code: asset1.safecode, link_class: 'other', url: 'example.com/test' }}
  ...
  test "Create link with invalid asset rejected" do
    ...
    post :create, params: { asset_web_link: { asset_code: 'ZLP_XX-1234', link_class: 'other', url: 'example.com/test' }}

...
class AssetSaveTest < ActiveSupport::TestCase
  ...
  test "All calculated fields applied for a point site" do
    ...
    assert asset1.region=='OT', "Region looked up from location"+asset1.region
    assert asset1.district=='CO', "District looked up from location"+asset1.district
    assert asset1.code=='ZLH/OT-0001', "Code applied based on region: "+asset1.code
    assert asset1.safecode=='ZLH_OT-0001', "Safe code generated"
    assert asset1.url=='assets/ZLH_OT-0001', "URL generated"
    asset1.reload
    assert asset1.area==nil, "No area calculated"
  end
